...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['update'])) {
        ...
        // SQL query to update data in the activity table
        $sql = "UPDATE activity SET Name='$name', Description='$description', Date='$date' WHERE ID='$id'";
        ...
        $insert_sql = "INSERT INTO activity (Name, Description, Date) VALUES ('$name', '$description', '$date')";
...
if (isset($_GET['delete'])) {
    ...
    // SQL query to delete record from activity table
...
<table>
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<td>" . $row["Date"] . "</td>";
            echo "<td><a href='?update=" . $row["ID"] . "'>Update</a> | <a href='activity.php?delete=" . $row["ID"] . "' onclick='return confirm(\"Are you sure you want to delete this record?\")'>Delete</a></td>";
            echo "</tr>";
        }
    } else {
...
if (isset($_GET['update'])) {
    ...
    $update_sql = "SELECT * FROM activity WHERE ID = '$update_id'";
